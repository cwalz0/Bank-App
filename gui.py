...
class LoginWindow(QWidget):
    ...
    def validate_login(self) -> None:
        ...
        """
        user: str = self.user_input.text().strip()
    ...
    def open_dashboard(self, user: str) -> None:
        ...
        Args:
            user (str): The username of the logged-in user.
        """
...
class DashboardWindow(QWidget):
    ...
    def __init__(self, username: str) -> None:
        ...
        self.savings_account: SavingsAccount | None = SavingsAccount(username) if savings_balance > 0 else None

        if self.savings_account:
            self.savings_account.set_balance(savings_balance)
        self.deposit_counter: int = deposit_counter
        ...
        # Create savings and logout buttons
    ...
    def update_account_info(self) -> None:
        """
        Update the account and savings balances in the UI and save them to the database.
        """
    ...
    def logout(self) -> None:
        """Log the user out and return to the login window."""
